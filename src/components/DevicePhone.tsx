  ...
  return (
    ...
    >
      <div className="relative h-[500px] rounded-[34px] bg-[#0f1720] p-[9px] shadow-[0_28px_50px_rgba(18,40,70,0.32),0_0_0_2px_#1a2430]">
        ...
        <div className="flex h-full flex-col overflow-hidden rounded-[26px] bg-surface-mid">
          <div className="flex justify-between bg-brand px-3.5 pt-3 pb-0.5 text-[9px] font-bold text-white">
            <span>9:41</span>
            <span>●●● 100%</span>
          </div>
          <div className="flex items-center gap-1.5 bg-brand px-3 pb-2.5">
            <img
              src="/glucosemeter.png"
              alt=""
              className="size-5 rounded-md bg-ink"
            />
            <strong className="text-[13px] font-semibold text-white">Dose</strong>
          </div>
          <div className="flex-1 overflow-hidden px-2.5 pt-2.5 pb-2">
            ...
            <div className="mb-1.5 rounded-lg border border-brand/20 bg-brand-softer/40 px-1.5 py-1 text-[7px] leading-snug font-semibold text-brand-dark">
              Estimativa com base no seu perfil. Não substitui orientação médica.
            </div>
            <div className="mb-1.5 rounded-[11px] border border-[#e2e8f0] bg-white px-2.5 py-2 shadow-sm">
              ...
              <div className="rounded-lg border border-brand/25 bg-surface px-2 py-2 text-center">
                <div className="text-[28px] leading-none font-extrabold">142</div>
                <div className="text-[9px] font-semibold text-muted">mg/dL</div>
              </div>
            </div>
            <div className="rounded-[11px] border border-[#e2e8f0] bg-white px-2.5 py-2 shadow-sm">
              <div className="mb-1.5 flex items-center gap-1.5 text-[9px] font-bold">
              ...
              <div className="mb-1.5 flex items-center gap-1 rounded-lg border border-line bg-[#f8fafc] px-1.5 py-1">
                <span className="flex-1 text-[8px] leading-snug text-muted">
                  Ex: 2 pães franceses com queijo
                </span>
                <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-brand text-[8px] text-white">
                  ●
                </span>
              </div>
              <div className="mb-1.5 flex gap-1.5">
                <span className="flex flex-1 items-center justify-center rounded-lg border-[1.5px] border-line bg-white px-1 py-1.5 text-[8px] font-bold text-brand-dark">
                  Câmera
                </span>
                <span className="flex flex-1 items-center justify-center rounded-lg border-[1.5px] border-line bg-white px-1 py-1.5 text-[8px] font-bold text-brand-dark">
                  Galeria
              ...
              <div className="rounded-lg bg-brand px-1 py-2 text-center text-[9px] leading-tight font-bold text-white">
